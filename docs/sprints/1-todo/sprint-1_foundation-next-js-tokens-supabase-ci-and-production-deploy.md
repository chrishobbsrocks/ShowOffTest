...
- External: Supabase and Vercel projects exist (operator, done). The operator supplies environment variable values to Vercel, and connects Supabase's GitHub integration to `chrishobbsrocks/ShowOffTest` using Dev Team's step-by-step, before Pipeman pushes this sprint.
